...
urlpatterns = [
    ...
    path('reports/tat-adherence/', report_views.tat_analytics_simple, name='tat_analytics_simple'),
    
    # Project Ageing Report Dashboard
    path('reports/ageing-report/', report_views.ageing_report_dashboard, name='ageing_report_dashboard'),
